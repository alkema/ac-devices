class CreateDeviceReadings < ActiveRecord::Migration[6.0]
  def change
    ...
    add_index :device_readings, [:device_id, :temperature]
    add_index :device_readings, [:device_id, :humidity]
    add_index :device_readings, [:device_id, :carbon_monoxide]
    add_index :device_readings, [:device_id, :health_status]
